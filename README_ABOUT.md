...
- Добавил бы линтер кода, в текущей версии проверяется только валидность typescript, взял бы за основу eslint-config-airbnb с добавлением/переопределением правил. 
